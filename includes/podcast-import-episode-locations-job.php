 ...
 *
 * Pairs with {@see Export_Import::expand_export()} XML shape.
 */
final class PodcastImportEpisodeLocationsJob
{
    use JobTrait;
    ...
    {
        return 'Podcast Import: Episode Locations';
    }

    public static function description()
    {
        return 'Imports episode location records (subject & creator).';
    }
